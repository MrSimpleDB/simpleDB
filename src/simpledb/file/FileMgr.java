...
public class FileMgr {
   ...
   private void updateReadBlockStats(Block blk){
	   String fname=blk.fileName();
	   this.blockStatsFile.get(fname).incrementBlockRead();	   
   }
   
   private void updateWriteBlockStats(Block blk){
	   String fname=blk.fileName();
	   this.blockStatsFile.get(fname).incrementBlockWritten();
   }
